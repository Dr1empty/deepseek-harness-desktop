...
本文只记录桌面封装与 CLEAN 发行版的变化；Harness 内核变化请查看其[上游更新记录](https://github.com/deepseek-ai/deepseek-harness/releases)。
...
- CLEAN 发行版保留滑动变阻器皮肤和超级模组注入器，不包含 Vision Router、iMessage 与质谱接口。
- 增加可复现 CLEAN 构建准备、发布哈希与发布清单生成流程。
