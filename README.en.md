...
[Bilingual home](README.md#english) | [中文](README.zh.md)
...
Model requests and balance queries contact DeepSeek services. Kernel checks contact npm Registry. User-initiated login and top-up contact the DeepSeek Open Platform. Desktop Setup downloads come from GitHub Releases. See [PRIVACY.md](apps/desktop/PRIVACY.md) for details.
...
Upstream Harness code and trademarks remain subject to upstream licenses and policies. Desktop-owned code is released under the [MIT License](apps/desktop/LICENSE). See [THIRD_PARTY_NOTICES.md](apps/desktop/THIRD_PARTY_NOTICES.md) for third-party notices and [CHANGELOG.md](apps/desktop/CHANGELOG.md) for version history.
